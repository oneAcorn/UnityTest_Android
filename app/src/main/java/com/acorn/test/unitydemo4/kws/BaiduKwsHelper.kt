...
import com.acorn.test.unitydemo4.utils.LogUtil
 ...
 */
class BaiduKwsHelper(private val activity: FragmentActivity,private val listener: IBaiduKwsListener? = null) : EventListener {
    ...
    fun start() {
        ...
        LogUtil.outI("wakeup start")
    }

    fun stop() {
        wakeup?.send(SpeechConstant.WAKEUP_STOP, "{}", null, 0, 0)
        LogUtil.outI("wakeup stop")
    }
    ...
    override fun onEvent(
        ...
        LogUtil.outI("kws onEvent:$logTxt")
