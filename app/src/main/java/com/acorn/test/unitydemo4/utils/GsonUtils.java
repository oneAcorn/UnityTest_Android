...
//    public static RequestBody toRequestBody(Object o) {
//        return RequestBody.create(MediaType.parse("application/json;charset=utf-8"), toJson(o));
//    }
...
//	}
    ...
    /**
     * 将map集合转换成相对应的字符串并在json前在字符串"&"
     *
     * @param map
     * @return
     */
    public static <T> String toJsonFromMapJoinMark(Map<String, T> map) {
        try {
            Gson gson = getGson();
            TypeToken<Map<String, T>> type = new TypeToken<Map<String, T>>() {
            };
